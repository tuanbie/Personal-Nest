...
export class Migrations1696997527842 implements MigrationInterface {
    name = 'Migrations1696997527842'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "fullname" character varying(255)`);
