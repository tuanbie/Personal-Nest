...
export class Migrations1696989566110 implements MigrationInterface {
    name = 'Migrations1696989566110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "photo" ("imageId" SERIAL NOT NULL, "url" character varying NOT NULL, "type" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_0824afd24d4163bfd384ae04f4b" PRIMARY KEY ("imageId"))`);
